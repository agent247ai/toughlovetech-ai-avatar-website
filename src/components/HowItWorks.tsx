...
const Step = ({ number, icon, title, description, details, isLast }: StepProps) => {
  return (
    <motion.div
      ...
      {/* Step Card */}
      <div className="relative bg-gradient-to-b from-card to-surface-1 rounded-2xl p-8 border-2 border-primary/20 hover:border-primary/40 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10 group-hover:scale-105 !w-full !h-[485px]">
        {/* Step Number */}
